CREATE OR REPLACE FUNCTION credit_wallet(
  ...
  p_type TEXT DEFAULT 'credit', p_description TEXT DEFAULT '',
...
BEGIN
  ...
  UPDATE wallets SET balance = v_balance_after, total_earned = total_earned + p_amount, updated_at = NOW() WHERE user_id = p_user_id;
