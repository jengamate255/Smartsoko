...
if not exist "gradlew.bat" (
    echo [ERROR] Customer app gradlew not found. Skipping...
    goto :BUILD_MERCHANT
)
...
if %errorlevel% equ 0 (
    echo [SUCCESS] Customer APK build successful!
...
if not exist "gradlew.bat" (
    echo [ERROR] Merchant app gradlew not found. Skipping...
    goto :BUILD_DRIVER
)
...
if %errorlevel% equ 0 (
    echo [SUCCESS] Merchant APK build successful!
    ...
    echo [ERROR] Merchant APK build failed!
)
...
if not exist "gradlew.bat" (
    echo [ERROR] Driver app gradlew not found. Skipping...
    goto :BUILD_COMPLETE
)
...
if %errorlevel% equ 0 (
    echo [SUCCESS] Driver APK build successful!
    ...
    echo [ERROR] Driver APK build failed!
)
...
echo.
echo Live URLs:
echo   Customer: https://smartsoko-marketplace.vercel.app/customer.html
echo   Merchant: https://smartsoko-marketplace.vercel.app/merchant.html
echo   Driver:   https://smartsoko-marketplace.vercel.app/driver.html
echo.
