  ...
  try {
    ...
    if (serviceAccountBase64) {
      ...
      if (!serviceAccountPath) {
        console.log('⚠️ No Firebase service account file found and FIREBASE_SERVICE_ACCOUNT_BASE64 is not set');
        return false;
      }
...
app.post('/api/orders', asyncHandler(async (req, res) => {
  ...
  // Basic validation
  const { customerId, sellerId, items, total, deliveryAddress } = req.body;
