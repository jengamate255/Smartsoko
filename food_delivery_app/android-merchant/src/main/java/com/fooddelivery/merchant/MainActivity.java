...
public class MainActivity extends Activity {
    ...
    private void loadMerchantApp() {
        ...
        if (lastUrl != null && !lastUrl.isEmpty()) {
            ...
            // Load merchant app
            webView.loadUrl("https://smartsoko-marketplace.vercel.app/merchant.html");
        } else {
            loadOfflinePage();
        }
    }
    ...
    private void handleMerchantDeepLink(String url) {
        ...
        if (path != null) {
            if (path.equals("/order")) {
                ...
                if (orderId != null) {
                    webView.loadUrl("https://smartsoko-marketplace.vercel.app/merchant.html?order=" + orderId);
                }
            } else if (path.equals("/analytics")) {
                webView.loadUrl("https://smartsoko-marketplace.vercel.app/merchant.html?tab=analytics");
            } else if (path.equals("/menu")) {
                webView.loadUrl("https://smartsoko-marketplace.vercel.app/merchant.html?tab=menu");
            }
        }
    }
